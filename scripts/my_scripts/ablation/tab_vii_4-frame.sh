...
#   Mono_SF_MF_video
#   Mono_SF_MF_softsplat_lstm
#   raft_sf_mf_mem_4f
#   Mono_SF_MF  # Please comment out the position-enhanced motion feature aggregation in the model. By uncommenting the MIP module, 4-frame extension can be enabled.
...
SAVE_PATH="$EXPERIMENTS_HOME/ablation/tab_vii_4-frame/$ALIAS$TIME"
CHECKPOINT='None'
