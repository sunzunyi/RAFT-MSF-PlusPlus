...
#   raft_sf_mf_corr   #  multi-frame raft model with correlation volume, like Multi-Mono-SF
#   raft_sf_mf_video_3f # VideoFlow-TOF
#   raft_sf_mf_mem_4f  # MemFlow
#   Mono_SF_MF    #   Please comment out the position-enhanced motion feature aggregation in the model.
#   raft_sf_mf_mhs_corr # RAFT-MSF++ with Bid-correlation volume


# save path
ALIAS=""
TIME=$(TZ=UTC-8 date +"%Y%m%d-%H-%M-%S")
SAVE_PATH="$EXPERIMENTS_HOME/ablation/tab_iv_multi-frame_extension/$ALIAS$TIME"
CHECKPOINT='None'
