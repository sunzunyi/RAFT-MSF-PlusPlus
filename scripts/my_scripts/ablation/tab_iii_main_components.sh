...
# model
MODEL=Mono_SF_MF 
#  Please comment out the position-enhanced motion feature aggregation in the model.
#  Uncommenting `start_occ_reg = 10` enables occlusion regularization.


# save path
ALIAS=""
TIME=$(TZ=UTC-8 date +"%Y%m%d-%H-%M-%S")
SAVE_PATH="$EXPERIMENTS_HOME/ablation/tab_vi_mhs_fusion_strategy/$ALIAS$TIME"
CHECKPOINT='None'
