...
Valid_Dataset=KITTI_2015_Test # KITTI_2015_Train_Full_mnsf_4f
Valid_Augmentation=Augmentation_Resize_Only_MV # Augmentation_Resize_Only
Valid_Loss_Function=Eval_SceneFlow_KITTI_Test_MV  #  Eval_SceneFlow_KITTI_Test   Eval_SceneFlow_KITTI_Train_MV

# training configuration
# save path
ALIAS="-fintune-submission"
