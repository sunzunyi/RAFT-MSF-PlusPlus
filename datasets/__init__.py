...
KITTI_2015_Train_Full_mnsf_4f = kitti_2015_train.KITTI_2015_MonoSceneFlow_Full_MV    # In the three-frame model, only the first three frames (09, 10, 11) are used

KITTI_Raw_4f  = kitti_raw_monosf.KITTI_Raw_Train_mf